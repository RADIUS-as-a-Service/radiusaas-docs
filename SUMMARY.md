...
* [Settings](portal/settings/README.md)
  * [Server Settings](portal/settings/settings-server/README.md)
    * [Ports & IP Addresses](portal/settings/settings-server/ports-and-ip-addresses.md)
    * [Certificates](portal/settings/settings-server/certificates.md)
    * [Optional Settings](portal/settings/settings-server/optional-settings.md)
  * [Authentication Certificates](portal/settings/settings-trusted-roots/README.md)
    * [Trusted Roots for Client Authentication](portal/settings/settings-trusted-roots/trusted-roots.md)
    * [Intune Certificate](portal/settings/settings-trusted-roots/intune-cert.md)
    * [XML](portal/settings/settings-trusted-roots/xml.md)
  * [RADIUS Proxies](portal/settings/settings-proxy.md)
