...
This setting controls the maximum TLS version used with EAP when your endpoints authenticate against your RADIUSaaS instance using a certificate (EAP-TLS) or [username/password credentials](../users/users.md#protocols).
