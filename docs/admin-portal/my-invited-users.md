...
Any identity or accounts that has been assigned the [**Users**](access-and-rules/permissions.md#users) role, is able to create [username/password accounts](users/users.md) with [certain constraints](access-and-rules/user-settings.md).&#x20;
