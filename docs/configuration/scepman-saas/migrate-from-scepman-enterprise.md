...
While technically possible through [Bring your own Key Vault](../../admin-portal/settings/scepman-1.md#scepman-identity-and-keys), reusing your existing Root CA certificate is not recommended for the following reasons:
