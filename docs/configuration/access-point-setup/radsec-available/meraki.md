...
6.  Under **RADIUS**, click **Add server**. Configure the **IP address** to match the [**RadSec IP**](../../../admin-portal/settings/settings-server.md#properties) address of your RADIUSaaS instance, set the **Port** to 2083 and  set the **Secret** value to "radsec" and activate the **RadSec** checkbox.\
