...
* [Settings](admin-portal/settings/README.md)
  ...
  * [Rules](admin-portal/settings/rules/README.md)
    ...
    * [Groups](admin-portal/settings/rules/groups.md)
    * [Certificate Extensions](admin-portal/settings/rules/certificate-extensions.md)
    * [Attribute Catalogue](admin-portal/settings/rules/attribute-catalogue.md)
