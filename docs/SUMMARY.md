...
* [Getting Started](configuration/get-started/README.md)
...
* [Access Point Setup](configuration/access-point-setup/README.md)
  * [RadSec](configuration/access-point-setup/radsec-available/README.md)
    ...
    * [FortiNet](configuration/access-point-setup/radsec-available/fortinet.md)
    ...
    * [UniFi](configuration/access-point-setup/radsec-available/unifi.md)
  * [RADIUS](configuration/access-point-setup/proxy-needed/README.md)
    ...
    * [Sophos UTM](configuration/access-point-setup/proxy-needed/sophos-utm.md)
    * [UniFi](configuration/access-point-setup/proxy-needed/unifi.md)
* [Server Certificate Renewal](configuration/renew-certificate.md)

## Admin Portal

* [Home](admin-portal/home.md)
* [Insights](admin-portal/insights/README.md)
...
* [Settings](admin-portal/settings/README.md)
  ...
  * [Rules](admin-portal/settings/rules/README.md)
    * [General Structure](admin-portal/settings/rules/general-structure.md)
    * [WiFi](admin-portal/settings/rules/wifi.md)
    * [LAN](admin-portal/settings/rules/lan.md)
    * [VPN](admin-portal/settings/rules/vpn.md)
  * [Log Exporter](admin-portal/settings/log-exporter/README.md)
    * [Teams](admin-portal/settings/log-exporter/teams.md)
...
* [Microsoft Intune](profile-deployment/microsoft-intune/README.md)
  * [Server Trust](profile-deployment/microsoft-intune/trusted-root.md)
  * [WiFi Profile](profile-deployment/microsoft-intune/wifi-profile/README.md)
    * [Windows](profile-deployment/microsoft-intune/wifi-profile/windows.md)
    * [iOS/iPadOS & macOS](profile-deployment/microsoft-intune/wifi-profile/apple-devices.md)
    * [Android](profile-deployment/microsoft-intune/wifi-profile/android.md)
  * [Wired Profile](profile-deployment/microsoft-intune/wired-profile/README.md)
    * [Windows](profile-deployment/microsoft-intune/wired-profile/windows.md)
    * [macOS](profile-deployment/microsoft-intune/wired-profile/mac.md)
* [Jamf Pro](profile-deployment/jamf-pro/README.md)
